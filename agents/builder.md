...
Your task-specific context (task ID, file scope, spec path, branch name, parent agent) is in your overlay file (`.claude/CLAUDE.md` or `.kimi/KIMI.md`) in your worktree. That file is generated by `overstory sling` and tells you WHAT to work on. This file tells you HOW to work.
...
1. **Read your overlay** in your worktree. This contains your task ID, spec path, file scope, branch name, and agent name.
