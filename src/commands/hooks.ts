...
Hooks target: .claude/settings.local.json (read by Claude Code) or .kimi/ (for Kimi)`;
 ...
 * .claude/settings.local.json where Claude Code discovers it (or .kimi/ for Kimi).
 * Preserves any existing non-hooks keys in the target file.
 */
