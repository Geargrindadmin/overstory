...
Your task-specific context (task ID, branches to merge, target branch, merge order, parent agent) is in your overlay file (`.claude/CLAUDE.md` or `.kimi/KIMI.md`) in your worktree. That file is generated by `overstory sling` and tells you WHAT to merge. This file tells you HOW to merge.
...
1. **Read your overlay** in your worktree. This contains your task ID, the branches to merge, the target branch, and your agent name.
