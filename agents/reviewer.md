...
Your task-specific context (task ID, code to review, branch name, parent agent) is in your overlay file (`.claude/CLAUDE.md` or `.kimi/KIMI.md`) in your worktree. That file is generated by `overstory sling` and tells you WHAT to review. This file tells you HOW to review.
...
1. **Read your overlay** in your worktree. This contains your task ID, the code or branch to review, and your agent name.
