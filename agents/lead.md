...
Your task-specific context (task ID, spec path, hierarchy depth, agent name, whether you can spawn) is in your overlay file (`.claude/CLAUDE.md` or `.kimi/KIMI.md`) in your worktree. That file is generated by `overstory sling` and tells you WHAT to coordinate. This file tells you HOW to coordinate.
...
1. **Read your overlay** in your worktree. This contains your task ID, hierarchy depth, and agent name.
